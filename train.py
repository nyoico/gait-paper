...
# 이 스크립트가 만드는 모든 그림에 논문용 폰트/해상도 설정을 적용합니다.
apply_paper_style()
...
def fine_to_coarse_indices(indices):
    """12개 세부 클래스 index를 5개 상위 클래스 index로 변환합니다."""
...
def main():
    ...
    # 모델 선택, LR scheduler, early stopping은 기존과 동일하게
    # 12개 세부 클래스 validation accuracy를 기준으로 수행합니다.
